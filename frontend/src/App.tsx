      ...
      <header className="bg-primary text-white">
        <div className="max-w-6xl mx-auto px-6 py-4">
          ...
          <p className="text-xs text-gray-400 mt-0.5">
            東証グロース市場の割安小型成長株を自動選定 &amp; Alphaトラッキング
          </p>
        </div>
      </header>
              ...
              <div className="bg-white rounded-lg border border-gray-100 overflow-hidden">
                  ...
                  <div>
                    ...
                    <ul className="space-y-0.5">
                      <li className="text-xs text-gray-700">
                        <span className="text-success font-semibold">オーナー企業</span>判定
                      </li>
                ...
                <div className="px-5 py-2.5 bg-gray-50/60 border-t border-gray-100">
                  <p className="text-[11px] text-muted/70 leading-relaxed">
                    <b>LLM評価:</b> EDINET有価証券報告書全文を Gemini 2.5 Flash で分析。
                    創業家・同族経営のオーナー企業かどうかを判定し、開示品質・戦略記述・ガバナンス記述から経営品質を 1-100 で採点。
                  </p>
                </div>
              </div>
            </section>
